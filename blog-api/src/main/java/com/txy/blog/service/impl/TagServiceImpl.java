...
import com.txy.blog.dao.mapper.TagMapper;
...
public class TagServiceImpl implements TagService {
    ...
    public Result hots(int limit) {
         ...
         * 2. 查询 根据tag_id分组，计数，从大到小排列，取前limit就可以了
         * select sum(*) count,tag_id from article_tag
         * group by tag_id order by count desc limit 2;
         */
